...
website_dems <- global_raw %>%
  ...
  mutate(cempstat = case_when(cempstat_sq001 == 0 ~ 1,
                              cempstat_sq001 == 1 ~ 2,
                              cempstat_sq008 == 1 ~ 3),
...
<!-- global_raw$continent <- countrycode(sourcevar = global_raw[, "country_iso"], -->
<!--                             origin = "country.name", -->
...
Very few responses for July, Aug, and Sept (192, 41, 2 respectively)
 
This arguably makes these new results a little less interesting (for instance, the overall demographics haven’t budged).
 
I’d like to propose new graphs — different visuals to offer a “fresh” look at the data.
 
The team may prefer using the same graphs.
 
* Q1: Should we be trying to make new results compelling?

* Q2: Is the team planning on using these new results for a specific meetings/date?
 
I will adjust the gameplan accordingly.